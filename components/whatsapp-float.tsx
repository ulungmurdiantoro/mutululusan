...
export function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-50 flex h-13 w-13 items-center justify-center rounded-full bg-green-500 shadow-lg transition hover:scale-105 hover:bg-green-400 md:bottom-6 md:right-6"
    >
