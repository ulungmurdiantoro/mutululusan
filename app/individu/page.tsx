...
const trustItems = [
  ...
  { label: "21 Program 2026", detail: "online & offline" },
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 sm:py-24">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-relaxed text-slate-600">
              Pelatihan kompetensi laboratorium bersertifikat 24 JP — daftar online, bayar
              langsung, langsung dapat akses. K3 laboratorium, GLP, QC/QA, jaminan mutu, hingga
