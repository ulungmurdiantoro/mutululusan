...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${site.url}/individu`, lastModified, changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${site.url}/ajukan-penawaran`, lastModified, changeFrequency: "monthly", priority: 0.7 },
  ...
  const programPages: MetadataRoute.Sitemap = allPrograms.map((program) => ({
